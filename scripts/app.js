...
var states = [
        ...
        { name: 'learn.category', state : {url : '/learn/:categoryId', parent: 'main', templateUrl: 'views/main/learn.html', controller: 'LearnCtrl', data:{text: "Learn category", visible:false}}},
