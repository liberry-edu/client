...
var states = [
        ...
        { name: 'learn', state: { url: '/learn', parent: 'main', templateUrl: 'views/main/learn.html', controller: 'LearnCtrl', data: {text: "Learn", visible: true } } },
        { name: 'learn.category', state : {url : '/learn/:categoryId', parent: 'main', templateUrl: 'views/main/category.html', controller: 'CategoryCtrl', data:{text: "Learn category", visible:false}}},
